...
export default {
    initApi<T = any, R = BaseAPIType.IAllowMethods<T>>(initParams: BaseAPIType.IInitParams<T>): R {
        ...
        [
            ...
            switch (method) {
                ...
                case APIMethods.LIST: {
                    allMethods[method] = (params: GlobalType.IRecord): Promise<BaseAPIType.IListResult<T>> => {
                ...
                case APIMethods.DELETE: {
                    allMethods[method] = (params: GlobalType.IRecord): Promise<IResponse> => {
